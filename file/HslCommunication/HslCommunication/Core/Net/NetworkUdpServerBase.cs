.+: Expression stack is empty at offset 0041.
   在 ..()
   在 ..()
   在 ..(Int32 offset)
   在 ..(Int32 end)
   在 ..(Int32 offset, Int32 end)
   在 ..(IExceptionHandler current, IExceptionHandler handler, ITryCatchFinallyStatement statement)
   在 ..(IExceptionHandler current)
   在 ..(Int32 offset, Int32 end)
