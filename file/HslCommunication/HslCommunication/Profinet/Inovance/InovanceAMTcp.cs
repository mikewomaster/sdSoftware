namespace HslCommunication.Profinet.Inovance
{
    ...
    public class InovanceAMTcp : ModbusTcpNet
    {
        ...
        public InovanceAMTcp(string ipAddress, [Optional, DefaultParameterValue(0x1f6)] int port, [Optional, DefaultParameterValue(1)] byte station) : base(ipAddress, port, station)
        {
        }
